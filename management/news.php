<?php
	...
	if (isset($_GET['editAdmin'])) {
		$getData = $news->getOne($common->get_prep($_GET['editRef']));
		$editAdmin = true;
			
	} else if (isset($_GET['deleteAdmin'])) {
		$edit = $news->remove($common->get_prep($_GET['del']));
		if ($edit) {
			header("location: ?done");
		} else {
			header("location: ?error");
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            News
            <small>Manage News Content</small>
          </h1>
          <ol class="breadcrumb">
            ...
            <div class="box box-primary">
              ...
              <form role="form" method="post" action="">
                ...
                <div class="form-group">
                  <label for="tags">
                  News Content
                  <p class="help-block">Enrer content for news </p>
                  </label>
                  <span id="sprytextarea1">
                  <textarea name="content" rows="15" required class="form-control" id="content"><?php echo $getData['content']; ?></textarea>
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><?php echo $common->truncate($list[$i]['content'], 25); ?></td>
                        ...
                        <td><a href="?view&editAdmin&editRef=<?php echo $list[$i]['ref']; ?>">view</a> | <a href="?editAdmin&editRef=<?php echo $list[$i]['ref']; ?>">edit</a> | <a href="?deleteAdmin&del=<?php echo $list[$i]['ref']; ?>" onClick="return confirm('this action will remove this section. are you sure you want to continue ?')">delete</a></td>
                      </tr>
                      <?php }
						unset($i); 
						unset($sn); ?>
