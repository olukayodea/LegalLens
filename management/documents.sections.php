	...
	if ((isset($_POST['editButton'])) || (isset($_POST['addAdmin'])) || (isset($_POST['editButton_2']))) {
		...
		if ($add) {
			if (isset($_POST['editButton_2'])) {
				header("location: documents?done&id=".$id);
			} else {
              ...
              <form role="form" method="post" action="">
                  <div class="box-body">
                    <div class="form-group">
                      <label for="section_no"><?php echo $sub_title; ?> Number <em>*</em> </label>
                  ...
                  <?php if ($data['type'] == "Books") { ?>
                    <div class="form-group">
                      <label for="sub_section"><?php echo $sub_title; ?> Sub Section <em>*</em> </label>
                      <span id="sprytextfield2">
                        <input type="text" name="sub_section" class="form-control" id="sub_section" placeholder="Sub Section" value="<?php echo $getData['sub_section']; ?>">
                        <span class="textfieldRequiredMsg">A value is required.</span></span></div>
                     <?php } ?>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="hidden" name="document" id="document" value="<?php echo $id; ?>">
