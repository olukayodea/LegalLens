<?php
	...
	if (isset($_GET['editAdmin'])) {
		$getData = $library->getOne($common->get_prep($_GET['editRef']));
		$editAdmin = true;
			
	} else if (isset($_GET['deleteAdmin'])) {
		$edit = $library->remove($common->get_prep($_GET['del']));
		if ($edit) {
			header("location: ?done");
		} else {
			header("location: ?error");
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Law Dictionary</li>
          </ol>
        </section>
              ...
              <form role="form" method="post" action="">
                  <div class="box-body">
                    <div class="form-group">
                      <label for="title">Content Title <em>*</em>
                      </label>
                      <span id="sprytextfield1">
                      <input type="text" name="title" class="form-control" id="title" placeholder="Title" value="<?php echo $getData['title']; ?>">
                      <span class="textfieldRequiredMsg">A value is required.</span></span></div>
                <div class="form-group">
                    <label for="details">Content<em>*</em>
                    </label>
                    <span id="sprytextarea1">
                    <textarea name="details" class="form-control" id="details" placeholder="Content"><?php echo $getData['details']; ?></textarea>
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><?php echo $common->truncate($list[$i]['details'], 40); ?>...</td>
