<?php
	...
	if ((isset($_POST['addAdmin'])) || (isset($_POST['editButton']))) {
		$add = $slider->add_s($_POST, $_FILES['media_file']);
		if ($add) {
			if ($add['info'] == "Done") {
	...
	if (isset($_GET['deleteAdmin'])) {
		$edit = $slider->remove_s($common->get_prep($_GET['id']));
		if ($edit) {
			header("location: ?done");
		} else {
...
<head>
    ...
    <title>LegalLens | Homepage Slider</title>
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Homepage Slider
            <small>Manage new and existing slider images</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="<?php echo URLAdmin; ?>"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active">Manage Homepage Slider Image</li>
          </ol>
        </section>
          ...
          <div class="row"><div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <form role="form" action="" method="post" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    <label for="media_file">Advert Image <em>*</em>
                    <p class="help-block">upload the home page banner picture, this image must not exceed 1300x620 (preferred) pixels </p></label>
                      <input type="file" name="media_file" class="form-control" id="media_file" accept="image/*" required>
                  </div>
                    <div class="form-group">
                      <label for="url">Advert URL
                      <p class="help-block">Enter optional URL of content</p></label>
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><a href="?deleteAdmin&id=<?php echo $list[$i]['ref']; ?>" onClick="return confirm('do you really want to remove this advert?')">delete</a></td>
                      </tr>
                      <?php }
                                    unset($i); 
                          unset($sn); ?>
