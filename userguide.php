<?php
	...
	$content = nl2br($page_content->getOneField("guide", "title", "content"));
?>
<!doctype html>
...
<script>
  (adsbygoogle = window.adsbygoogle || []).push({
    ...
    enable_page_level_ads: true
                ...
                <title>How to use Legal Lens library, Get help on legallens services</title>
                <meta name="description" content="Legal Lens library provides you with a wide array of legal resources. See how">
        ...
        <body>
                ...
                <div class="header-wrapper">
                        <?php $pages->headerFiles("userguide"); ?>
                </div>
                <!-- End of Header -->
