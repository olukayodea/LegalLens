    ...
    (adsbygoogle = window.adsbygoogle || []).push({});
        ...
        <div id="easyPaginate">
			<?php foreach ($list as $key => $value) { ?>
                ...
                <span>
                    <h5><a href="<?php echo URL; ?>mobile_regulations.view?id=<?php echo $list[$key][$i]['ref']; ?>"><?php echo strtoupper($list[$key][$i]['title']); ?></a></h5>
                    <p>
                    <?php $section_list = $regulations_sections->sortAll($list[$key][$i]['ref'], "regulations", "status", "active"); ?>
                    <?php for ($j= 0; $j < count($section_list); $j++) { ?>
                    <a href="<?php echo URL; ?>mobile_regulations.view?id=<?php echo $list[$key][$i]['ref']; ?>&read=<?php echo $section_list[$j]['ref']; ?>"><strong><?php echo nl2br($common->getLine($section_list[$j]['section_no'])); ?></strong></a>
                    <br>
                    <?php } ?>
                    </p>
                </span>
