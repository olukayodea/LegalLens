<?php
	$redirect = "managesavedpages";
	include_once("includes/functions.php");
	include_once("includes/session.php");
	
	if (isset($_GET['del'])) {
		$edit = $search_result->remove($common->get_prep($_GET['del']));
		if ($edit) {
	...
	$list = $search_result->sortAll($ref, "users");
?>
<!doctype html>
...
<script>
  (adsbygoogle = window.adsbygoogle || []).push({
    ...
    enable_page_level_ads: true
                ...
                <title>LegalLens |Manage Saved Pages </title>
    <?php $pages->head(); ?>
...
<table class="table table-hover">
   <thead>
	...
	<td><a href="<?php echo URL; ?>home?s=<?php echo $list[$i]['ref']; ?>">view</a></td>
