<?php
        ...
        $postToken = $common->createRandomPassword();        
        $message = "";
        $name = "";
        $reason = "";
        $email = "";
	...
	if (isset($_POST['submit'])) {
                if ($_POST['postToken'] == sha1($_SESSION['captiaCode'])) {
                                ...
                                <div class="row">
                                        ...
                                        <div class="span8 page-content">
                                                ...
                                                <form id="contact-form" class="row" action="" method="post">
                                                        <input type="hidden" value="<?php echo sha1($postToken); ?>" name="postToken">
                                                        <div class="span2">
                                                        ...
                                                        <div class="span2">
                                                                <label for="captcha">
                                                                        <img src="<?php echo URL; ?>includes/scripts/captcha.php?postToken=<?php echo $postToken; ?>" />
                                                                </label>
                                                        </div>
