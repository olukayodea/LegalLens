...
<script>
  (adsbygoogle = window.adsbygoogle || []).push({
    ...
    enable_page_level_ads: true
                ...
                <title>LegalLens | Search Case Index | Supreme Court(Court Name) </title>
    <?php $pages->head(); ?>
...
<div class="span7">
   <div style="border:1px solid #ccc; padding:10px">
       <!-- <div style="width:630px;height:130px;" >-->
           <div align="right" style="margin-botton:5px;">Your current subscription expires on: 3rd  December, 2016 </div>
           Welcome to to your membership area. This represent you membership ...<br>
	   Welcome to to your membership area. This represent you membership ...<br>
           Welcome to to your membership area. This represent you membership ...<br>
	<!-- </div> -->
        <div style="margin-top:30px">
 		<h4 style="" align="center">Quick Search </h4><p>
                Searching in Supreme Court Case law >>>
		<form id="search-form2" class="search-form2 clearfix" method="get" action="#" autocomplete="off">
