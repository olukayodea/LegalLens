...
<script>
  (adsbygoogle = window.adsbygoogle || []).push({
    ...
    <title>Legal Drafting >> Forms </title>
    <?php $pages->head(); ?>
<style>
...
<h4 style="" align="center">Forms</h4>
...
<div id="easyPaginate">
	<?php foreach ($list as $key => $value) { ?>
        ...
        <p><strong><a href="<?php echo URL; ?>mobile_clause.data?view=Forms&id=<?php echo $list[$key][$i]['ref']; ?>"><?php echo $list[$key][$i]['title']; ?></a></strong></p>
        <?php } ?>
    <?php } ?>
   ...
   <!-- <script type='text/javascript' src='js/jquery-1.8.3.min.js'></script> -->
	...
	<script>
        $(function() {
            ...
            $( "#s" ).catcomplete({
      		  delay: 0,
              source: "includes/scripts/auto_complete_clause.php?type=Forms",
