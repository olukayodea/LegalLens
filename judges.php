<?php
	...
	$list = $listItem->sortAll("Judge", "type", $sortType, $sort, "status", "active");
?>
<!DOCTYPE html>
...
<div class="span7">
   <div style="border:1px solid #ccc; padding:10px">
     <div style="margin-top:30px">
       <h4 style="" align="center">List of Judges in <?php echo $title; ?></h4>
               ...
               <!-- <script type='text/javascript' src='js/jquery-1.8.3.min.js'></script> -->
                ...
                <script>
					$(function() {
        				$("#example1").DataTable();
						$( "#s" ).autocomplete({
						  source: "includes/scripts/auto_complete_list.php?type=Judge"
						});
					});
				</script>
