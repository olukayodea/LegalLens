      ...
      <section class="invoice">
        ...
        <div class="row">
          ...
          <div class="col-xs-6">
            ...
            <p class="text-muted well well-sm no-shadow" style="margin-top: 10px;">This invoice has not been paid. You will not be able to access your account untill you settle this invoice.<br><br>other channel payment instruction here</p>
            <?php } ?>
          </div><!-- /.col -->
          <div class="col-xs-6">
