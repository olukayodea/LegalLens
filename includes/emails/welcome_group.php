<?php
	...
	$subscription_group_onwer = $common->get_prep($_REQUEST['subscription_group_onwer']);		
...
<table width="100%" border="0" cellspacing="0" cellpadding="5">
  ...
  <tr>
    ...
    <p class="text"><strong><?php echo $users->getOneField($subscription_group_onwer, "ref", "last_name")." ".$users->getOneField($subscription_group_onwer, "ref", "other_names"); ?></strong> recently added you as a user in his LegalLens subscription. You will be able to access the legalLens Libraryas long as his subscription is active</p>
    <p class="text">Please save this email for future use. Your account enables you to login to the system, and also stores any reward points you may have earned. Your details are now saved as below, you will need to create a new password on your first login:</p>
    <p class="text"><strong>Login Details</strong><hr>
    <p class="text">Email: <?php echo $email; ?><br>
    Password: <?php echo $password; ?><br></p>
