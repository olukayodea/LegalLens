        ...
        <div id="easyPaginate">
			<?php foreach ($list as $key => $value) { ?>
                ...
                <!--<h4><?php echo $key; ?></h4>-->
                    ...
                    <strong><a href="<?php echo URL; ?>mobilecaselaw.view?id=<?php echo $list[$key][$i]['ref']; ?>&jump=<?php echo $list[$key][$i]['section_ref']; ?>"><?php echo $list[$key][$i]['areas']; ?></a></strong><br>
                    <?php } ?>
                    <?php for ($j= 0; $j < count($section_list); $j++) { ?>
                    <a href="<?php echo URL; ?>mobilecaselaw.read?id=<?php echo $list[$key][$i]['ref']; ?>&read=<?php echo $section_list[$j]['ref']; ?>"><?php echo nl2br($common->getLine($section_list[$j]['section_content'])); ?>
                    <br>
