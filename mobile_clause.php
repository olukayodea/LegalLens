...
<script>
  (adsbygoogle = window.adsbygoogle || []).push({
    ...
    <title>Legal Drafting >> Clauses </title>
    <?php $pages->head(); ?>
<style>
...
<div id="easyPaginate">
	<?php foreach ($list as $key => $value) { ?>
        ...
        <p><strong><a href="<?php echo URL; ?>mobile_clause.data?view=Clauses&id=<?php echo $list[$key][$i]['ref']; ?>"><?php echo $list[$key][$i]['title']; ?></a></strong></p>
        <?php } ?>
    <?php } ?>
